...
export default function Github(props: any) {
  ...
  {/* if (github != null && main != "Github") {
    return (
      <Link
        href={github}
        className="bg-[#0072d2] text-white px-4 py-4 text-base flex flex-row font-bold gap-1 w-fit rounded-full hover:bg-[#0082f0]"
        target="_blank"
      >
        <svg width="24px" height="24px" viewBox="0 0 24 24">
